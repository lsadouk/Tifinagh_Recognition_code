...
function BW_Thinned = thinning(BW_Original)
% load image data
%%addpath('./data')
%Img_Original = imread('data/32tifinaghData/hh/yahh_script_1_7.png'); 
...
% BW_Original = im2bw(Img_Original,Otsu_Threshold);
% BW_Original = 1 - BW_Original;
